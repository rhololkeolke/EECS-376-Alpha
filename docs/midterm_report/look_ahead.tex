...
in front of the robot and .25m on either side. \todo[color=blue]{Check
  the size of the box}.
...
\todo[color=yellow]{Insert Section Name}
...
\todo[color=blue]{Find out laser message data type}. This message
...
equations shown in figure {\bf NUMBER} \todo[color=blue]{insert figure number}
