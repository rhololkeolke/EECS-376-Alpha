...
class PathSegment(roslib.message.Message):
  _md5sum = "4dae7b14364cbd2942f9559f021d4cbb"
  _type = "msg_alpha/PathSegment"
...
"""
  ...
  __slots__ = ['header','seg_type','relative','seg_number','seg_length','ref_point','init_tan_angle','curvature','max_speeds','min_speeds','accel_limit','decel_limit']
  _slot_types = ['Header','int8','bool','uint32','float64','geometry_msgs/Point','geometry_msgs/Quaternion','float64','geometry_msgs/Twist','geometry_msgs/Twist','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,seg_type,relative,seg_number,seg_length,ref_point,init_tan_angle,curvature,max_speeds,min_speeds,accel_limit,decel_limit
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.seg_type, _x.relative, _x.seg_number, _x.seg_length, _x.ref_point.x, _x.ref_point.y, _x.ref_point.z, _x.init_tan_angle.x, _x.init_tan_angle.y, _x.init_tan_angle.z, _x.init_tan_angle.w, _x.curvature, _x.max_speeds.linear.x, _x.max_speeds.linear.y, _x.max_speeds.linear.z, _x.max_speeds.angular.x, _x.max_speeds.angular.y, _x.max_speeds.angular.z, _x.min_speeds.linear.x, _x.min_speeds.linear.y, _x.min_speeds.linear.z, _x.min_speeds.angular.x, _x.min_speeds.angular.y, _x.min_speeds.angular.z, _x.accel_limit, _x.decel_limit,) = _struct_bBI23d.unpack(str[start:end])
...
_struct_bBI23d = struct.Struct("<bBI23d")
